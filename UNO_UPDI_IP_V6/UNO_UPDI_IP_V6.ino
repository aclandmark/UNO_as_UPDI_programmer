//All test files programmed OK at 38.4KHz  Fills 16K flash in 16 seconds.
//FINAL UNO VERSION Break subroutine works reliably
//Odd record length dealt with


#include "Resources_UPDI_IP_V6.h"
...
sendString("\r\nUPDI programer: UNO_UPDI_IP_V6 (also works on an Atmega 328 clocked at 8MHz)\r\n\r\n");
