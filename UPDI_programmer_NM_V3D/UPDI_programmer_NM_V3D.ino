//All test files programmed OK at 38.4KHz  
//BREAK statement appears to function OK!!!!!!!!!!!!!!!
//Ready to integrate with subroutine version od program 


#include "UPDI_programmer_NM_V3D.h"
...
write_fuse (APPEND, 0x03);            //Default value: No flash partitions
write_fuse (BOOTEND, 0x04);          //Default value: No flash partitions
*/
