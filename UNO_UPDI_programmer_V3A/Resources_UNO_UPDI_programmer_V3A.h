...
#include "Resources_UPDI_programmer_V3A\UPDI_Programmer.h"
#include "Resources_UPDI_programmer_V3A\Basic_IO_and_Timer_subs.c"
#include "Resources_UPDI_programmer_V3A\ASKII_subroutines.c"
#include "Resources_UPDI_programmer_V3A\Hex_Programmer_subs.c"
#include "Resources_UPDI_programmer_V3A\Hex_Programmer.c"
#include "Resources_UPDI_programmer_V3A\UPDI_subroutines.c"
#include "Resources_UPDI_programmer_V3A\verify_flash.c"
