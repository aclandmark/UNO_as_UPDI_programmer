...
#include "Resources_UPDI_programmer_V2A\UPDI_Programmer.h"
#include "Resources_UPDI_programmer_V2A\Basic_IO_and_Timer_subs.c"
#include "Resources_UPDI_programmer_V2A\ASKII_subroutines.c"
#include "Resources_UPDI_programmer_V2A\Hex_Programmer_subs.c"
#include "Resources_UPDI_programmer_V2A\Hex_Programmer.c"
#include "Resources_UPDI_programmer_V2A\UPDI_subroutines.c"
#include "Resources_UPDI_programmer_V2A\verify_flash.c"
