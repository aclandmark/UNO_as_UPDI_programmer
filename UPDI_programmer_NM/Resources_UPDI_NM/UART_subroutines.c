...
//#define Start_clock_old \
//TCNT0 = 0; GTCCR |= (1 << PSRSYNC); TCCR0B = ((1 << CS01) ); 
...
//#define Restart_clock TCCR0B = 0; Start_clock_old;;

#define Reset_clock		TCCR0B = 0;	TCNT0 = 0; GTCCR |= (1 << PSRSYNC);

//T0 counts to 80 in 5uS.	It counts to 60 in 3.75uS

#define Tx_clock_LS            	80
#define Rx_clock_LS            	80
#define Half_Rx_clock_LS   		40
...
data_byte_Tx = download_SIB; transmit_byte;\
\
receive_byte; SIB_byte[0] = data_byte_Rx;\
for(int m = 1; m <= 15; m++){\
receive_byte; SIB_byte[m] = data_byte_Rx;}\
\
Stop_clock;\
\
for(int m = 0; m <= 15;m++){\
...
Stop_clock; Timer_T2_sub(T0_delay_100us);\
\
Reset_clock;\
Start_Tx_clock_LS;\
\
...
\
data_byte_Tx = 0x55; transmit_byte;\
data_byte_Tx = 0x82; transmit_byte;\
...
\
data_byte_Tx = 0x55; transmit_byte;\
data_byte_Tx = 0x89; transmit_byte;\
receive_byte; Stop_clock;\
sendHex(16, data_byte_Rx);
